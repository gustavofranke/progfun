  ...
  val books = Set( //List(
    ...
    Book(
      ...
      authors = List("Odersky, Martin", "Spoon, Lex", "Venners, Bill")))
                                                  ...
                                                  //| in, Spoon, Lex, Venners, Bill)), Book(Effective Java,List(Bloch, Joshua)), B
                                                  //| ook(Introduction to Functional Programming,List(Bird, Richard, Wadler, Phil)
                                                  //| ), Book(Structure and Interpretation of Computer programs,List(Abelson, Hera
                                                  //| ld, Sussman, Gerald J.)), Book(Java Puzzlers,List(Bloch, Joshua, Gafter, Nea
                                                  //| l)))
